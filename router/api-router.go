...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/about/open-source", controller.GetOpenSourceInfo)
		apiRouter.GET("/license", controller.GetOpenSourceInfo)
		...
		billingRoute.Use(middleware.AdminAuth())
		{
			...
			billingRoute.GET("/readiness", controller.GetSeedanceBillingReadiness)
